...
//and balance. Add methods for depositing and withdrawing money from the account,
...
const bankAccount = {
    ...
    deposit: function(amount) {
        amount > 60000 ? console.log('Требуется подтверждение легольности доходов')
        :(this.balance += amount);
    },
    withdraw: function(amount) {
      ...
      //  }
        amount <= this.balance 
           ? (this.balance -= amount) : console.log('Not enough money on the balance');
    },
...
console.log(res);
const [number, name, balance] = Object.values(bankAccount);
