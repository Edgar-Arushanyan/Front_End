...
//console.log(multiplyArrow(4, 5)); ReferenceError:нельзя вызывать до и после
...
console.log(res);// Возвращает индекс искомого эоемента (или -1 если такого элемента в массиве нет)

res = arr.includes('nine');
//console.log(arr); // Исходный массив не меняется
console.log(res);// Возвращает true если  искомый элемент есть в массиве (и false -1 если такого элемента)
