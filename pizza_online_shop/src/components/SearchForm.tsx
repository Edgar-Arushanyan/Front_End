...
//Описывает логику и  пользовательский интерфейс поисковой панели
const SearchForm: React.FC = () => {
  ...
  //хук useRef даёт нам абстакную ссылку которую мв можем повесить на любой элемент и по этому
  const inputRef = React.useRef<HTMLInputElement>(null);

  //хук useCallback используется для создании мемоизированной  call-back версии функции
